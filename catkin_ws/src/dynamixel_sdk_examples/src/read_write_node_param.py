...
# ROS parameters
motor_id = rospy.get_param("/dynamixel_read_write/id", 1)
motor_baudrate = rospy.get_param("dynamixel_read_write/baudrate", 57600 )
motor_devicename = rospy.get_param("dynamixel_read_write/devicename", "/dev/ttyUSB0")

# Default setting
DXL_ID                      = motor_id                 # Dynamixel ID : 1
BAUDRATE                    = motor_baudrate             # Dynamixel default baudrate : 57600
DEVICENAME                  = motor_devicename    # Check which port is being used on your controller
